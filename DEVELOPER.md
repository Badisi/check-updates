...
2. Push the changes
3. Create a new [GitHub release](https://github.com/Badisi/check-updates/releases/new)
4. Watch the results in: [Actions](https://github.com/Badisi/check-updates/actions)
